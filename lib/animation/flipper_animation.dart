...
class FlipperAnimatioln extends StatefulWidget {
  final Widget frontWidget;
  final Widget backWidget;
  const FlipperAnimatioln(
      {Key? key, required this.frontWidget, required this.backWidget})
      : super(key: key);

  @override
  State<FlipperAnimatioln> createState() => _FlipperAnimatiolnState();
}

class _FlipperAnimatiolnState extends State<FlipperAnimatioln>
